        ...
        if pmem_id== '' or pyear == '' or pmonth == '' or pday == '' or pday2 == '' or pweather =='' or ptitle=='' or pcontents=='':
            ...
            if fm=='':
                ...
                if fm == "OK" :
                    ...
                    # 구글 api 안쓸때 
                    file = open("G:/내 드라이브/text_file/test.txt", "w",encoding="UTF-8")
...
def WC(x):
    ...
    wc = WordCloud(color_func=color_func, font_path = '', max_words=1000, mask=mask, stopwords=stopwords, margin=10,
